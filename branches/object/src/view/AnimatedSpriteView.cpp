...
AnimatedSpriteView* AnimatedSpriteView::clone() const
{
    AnimatedSpriteView* obj = new AnimatedSpriteView(*this);
    return obj;
}
...
AnimatedSpriteView& AnimatedSpriteView::addAnime(std::string const& anime_name, int total_frames)
{
    video::IVideoDriver* driver = smgr_->getVideoDriver();
...
AnimatedSpriteView&
AnimatedSpriteView::playAnime(std::string const& anime_name, u32 duration, bool loop,
