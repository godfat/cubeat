...
APIEXPORT void    Demo_hide_map_warning(Demo*, int map_id); // not shared_ptr!
...
APIEXPORT int     Demo_get_ai_level(Demo*); // not shared_ptr!
...
APIEXPORT void    Demo_fill_statistics_from_lua(Demo*, char const*, int); // not shared_ptr!
...
APIEXPORT void    Demo_leave_and_cleanup(Demo*, bool); // not shared_ptr!
