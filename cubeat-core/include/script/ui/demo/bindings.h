...
APIEXPORT void    Demo_init_vs_ppl(Demo*, char const*, char const*); // not shared_ptr!
APIEXPORT void    Demo_init_vs_cpu(Demo*, char const*, char const*); // not shared_ptr!
APIEXPORT void    Demo_init_cpudemo(Demo*, char const*, char const*); // not shared_ptr!
