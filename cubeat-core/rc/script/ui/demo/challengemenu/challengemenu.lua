...
local function init(demo, parent)
  ...
  menu.btn_mode_1 = ui.new_text{ parent=parent, x=0, y=0, size=32, title='puzzle mode' }
  menu.btn_mode_1:set_scale(1.5)
  menu.btn_mode_2 = ui.new_text{ parent=parent, x=0, y=60, size=32, title='emergency mode' }
  menu.btn_mode_2:set_scale(1.5)
  menu.btn_mode_3 = ui.new_text{ parent=parent, x=0, y=120, size=32, title='unlimited mode'}
