...
function init(demo)
  ...
  menu_.btn_vs_cpu = ui.new_button( { parent = vorig_,
  ...
  menu_.btn_vs_ppl = ui.new_button( { parent = vorig_,
  ...
  menu_.btn_cpudemo = ui.new_button( { parent = vorig_,
  ...
  menu_.btn_tut = ui.new_button( { parent = vorig_,
  ...
  menu_.btn_quit = ui.new_button( { parent = vorig_,
