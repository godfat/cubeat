...
local act1_act1_ = {
  ...
  { ch=2, img="char1_new/glad", text="End" },
  
  { ch=1, text="" }
}
local act1_act2_ = {
  { ch=1, img="char1_new/glad", text="Let's go" },
  { ch=2, img="char2_new/glad", text="End" },
  
  { ch=1, text="" }
}
local act1_act3_ = {
  { ch=1, img="char1_new/glad", text="Let's go" },
  { ch=2, img="char3_new/glad", text="End" },
  
  { ch=1, text="" }
}
local act1_act4_ = {
  { ch=1, img="char1_new/glad", text="Let's go" },
  { ch=2, img="char4_new/glad", text="End" },
  
  { ch=1, text="" }
}
local act1_act5_ = {
  { ch=1, img="char1_new/glad", text="Let's go" },
  { ch=2, img="char5_new/glad", text="End" },
  
  { ch=1, text="" }
}
local act1_act6_ = {
  { ch=1, img="char1_new/glad", text="Let's go" },
  { ch=2, img="char6_new/glad", text="End" },
