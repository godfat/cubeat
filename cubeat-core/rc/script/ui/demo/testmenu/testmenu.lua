...
local function init(demo, parent)
  ...
  menu.btn_select:on_press(function(self)
    switch.load_page('select', {id="slide_out_title", keep_blocker=true}, { game_mode = 1, level = 0, last_menu = 'testmenu' })
  end)
  menu.btn_talk:on_press(function(self)
    switch.load_page('talk', {id="slide_out_title", keep_blocker=true})
  end)
