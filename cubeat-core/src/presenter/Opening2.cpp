...
//                                       Conf::i().SCREEN_W(), Conf::i().SCREEN_H());
    ...
    ctrl::EventDispatcher::i().get_timer_dispatcher("opening")->subscribe(
        bind(&Opening2::end, this), shared_from_this(), duration + 100); //+100 ms to make sure this happens later
...
//        std::cout << "Opening2 deletion scheduled." << std::endl;
//        function<void()> endcall = bind(&Opening2::end, this);
