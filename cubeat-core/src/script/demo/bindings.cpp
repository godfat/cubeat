...
void Demo_init_puzzle(Demo* self, char const* c1p, char const* scene_name, int puzzle_level, bool in_place) { // not shared_ptr!
    self->init_puzzle(c1p, scene_name, puzzle_level, in_place);
}
